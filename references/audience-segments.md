...
**What moves them:**
- "10x CPM on opted-in engagement" — rewarded economics
...
**Primary channels:** Newsletter-operator communities (The Sample, beehiiv blog, Substack Notes), LinkedIn creator/media content, direct outbound to newsletter operators with 100K+ subscribers.
...
**Primary products:** Enterprise Level (tier), Core Platform, ezID, Brand Deal Hunters, Custom Solutions.
...
**What they care about:**
- Getting accepted (20 spots/month — competitive)
...
- Scarcity is the value — don't apologize for 20-spot limit
...
### 8. Grandfathered Publisher (existing account under 250K)
...
### 9. Win-back Target (ex-customer on a competitor)
...
- Implicit stick: "If you ever want to come back and you're below 250K, Incubator is the only path — 20 spots/month, history doesn't guarantee one."
...
**What they care about:**
- Platform independence — YouTube takes 45% and controls the relationship
